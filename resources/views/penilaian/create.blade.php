        ...
        <div class="card-header bg-primary text-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    ...
                    Penilaian Aplikasi: <strong>{{ $rekapAplikasi->nama }}</strong>
                </h5>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="hidden" name="rekap_aplikasi_id" value="{{ $rekapAplikasi->id }}">
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                <input type="date" name="tanggal_deadline_perbaikan" id="tanggal_deadline_perbaikan"
                                    ...
                                    value="{{ old('tanggal_deadline_perbaikan') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="keputusan_assessment" id="keputusan_assessment"
                                ...
                                <option value="lulus_tanpa_revisi" {{ old('keputusan_assessment') == 'lulus_tanpa_revisi' ? 'selected' : '' }}>
                                    ✅ Lulus Tanpa Revisi
                                </option>
                                <option value="lulus_dengan_revisi" {{ old('keputusan_assessment') == 'lulus_dengan_revisi' ? 'selected' : '' }}>
                                    📝 Lulus Dengan Revisi
                                </option>
                                <option value="assessment_ulang" {{ old('keputusan_assessment') == 'assessment_ulang' ? 'selected' : '' }}>
                                    🔄 Assessment Ulang
                                </option>
                                <option value="tidak_lulus" {{ old('keputusan_assessment') == 'tidak_lulus' ? 'selected' : '' }}>
                                    ❌ Tidak Lulus
                                </option>
                            </select>
