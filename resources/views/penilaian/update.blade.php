        ...
        <div class="card-header bg-primary text-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    ...
                    Edit Penilaian: <strong>{{ $penilaian->rekapAplikasi->nama }}</strong>
                </h5>
            </div>
        </div>
            ...
            <form action="{{ route('penilaian.update', $penilaian->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control bg-light" value="{{ $penilaian->rekapAplikasi->nama }}" readonly>
                            <input type="hidden" name="rekap_aplikasi_id" value="{{ $penilaian->rekap_aplikasi_id }}">
                        </div>
                                ...
                                <div class="mb-2 p-2 bg-light rounded">
                                    ...
                                    <a href="{{ asset('storage/' . $penilaian->dokumen_hasil_assessment) }}"
                                       target="_blank" class="text-decoration-none">
                                        {{ basename($penilaian->dokumen_hasil_assessment) }}
                                    </a>
                                </div>
                            @endif
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                <input type="date" name="tanggal_deadline_perbaikan" id="tanggal_deadline_perbaikan"
                                       ...
                                       value="{{ old('tanggal_deadline_perbaikan', $penilaian->tanggal_deadline_perbaikan) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="keputusan_assessment" id="keputusan_assessment"
                                    class="form-select @error('keputusan_assessment') is-invalid @enderror">
                                <option value="">Pilih Keputusan</option>
                                <option value="lulus_tanpa_revisi"
                                        {{ old('keputusan_assessment', $penilaian->keputusan_assessment) == 'lulus_tanpa_revisi' ? 'selected' : '' }}>
                                    ✅ Lulus Tanpa Revisi
                                </option>
                                <option value="lulus_dengan_revisi"
                                        {{ old('keputusan_assessment', $penilaian->keputusan_assessment) == 'lulus_dengan_revisi' ? 'selected' : '' }}>
                                    📝 Lulus Dengan Revisi
                                </option>
                                <option value="assessment_ulang"
                                        {{ old('keputusan_assessment', $penilaian->keputusan_assessment) == 'assessment_ulang' ? 'selected' : '' }}>
                                    🔄 Assessment Ulang
                                </option>
                                <option value="tidak_lulus"
                                        {{ old('keputusan_assessment', $penilaian->keputusan_assessment) == 'tidak_lulus' ? 'selected' : '' }}>
                                    ❌ Tidak Lulus
                                </option>
                            </select>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <small class="text-muted mt-2">
                                <i class="bx bx-info-circle"></i>
                                Format: JPEG, PNG, JPG, GIF, SVG. Maksimal 2MB per file.
                            </small>
                            @error('fotos.*')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                @if($penilaian->penilaianFotos && $penilaian->penilaianFotos->count() > 0)
                    <div class="form-group mt-4">
                        <label class="form-label fw-bold mb-3">Foto yang sudah ada:</label>
                        <div class="row g-3">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                    <a href="{{ route('rekap-aplikasi.show', $penilaian->rekap_aplikasi_id) }}"
